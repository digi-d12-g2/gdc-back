...
public interface AbsenceRepository extends JpaRepository<Absence, Long>{
    ...
    public List<Absence> getAbsencesFromTwoDatesRangeAndAbsenceIdAndUserId(@Param("firstDate") LocalDate firstDate, @Param("secondDate") LocalDate secondDate, @Param("userId") Long userId);
